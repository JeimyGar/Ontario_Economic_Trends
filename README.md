...
3. In the next graph we are analyzing the correlation between taxes less subsidies and GDP at marker price. The graph shows a positive correlation which would indicate that as the economy grows, the net taxes also increases.  This strong correlation indicated that a well managed fiscal policy where increases in the GDP translate to higher net taxes. We do have to remember that correlation does not mean causation and there can be outside policies and economic factors that could influence this. An increased revenuew from taxes less subsidies is crucual for funding various goverment programs and services which can further stimulate the economy.   <img width="1612" alt="Q3" src="https://github.com/user-attachments/assets/c4be77e6-608c-48b3-a650-da36fd42c027" />
...
5. The last chart shows the changes in the consumption of fixed capital over the years. It has three charts, all starting in 1981 and ending in 2024. The first graph is for the consumption fo fixed capital: corporations, the second one is the consumption of fixed capital:government and nonprofit insitutions, and the third one is the consumption of fixed capital: Unincoporated businesses. All three graphs show a generally positive trend, which indicates overall ecnomic growth. These changes in the consumption of capital can be signals of a healthy economy. If we look at the the GDP Chart we can see a similar positive trend. As we saw before, higher GDP is positively corrolated with hgiher taxes less subsodoes and employee comp. As GDP, taxes and employee comp increase, the opportunity for investments in fixed assests like building, machinery and equipemt increase as well. All of which could then yield GDP growth. As corporations and small business see this cicle of investment, it incourages investors to reinvest in fixed income. <img width="1610" alt="Q7" src="https://github.com/user-attachments/assets/aa5b9385-3acb-4f99-b722-151bc35c3875" />
